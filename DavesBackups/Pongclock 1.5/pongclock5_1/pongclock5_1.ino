...
#define NUM_DISPLAYS 1                   // Num displays for shadow ram data allocation
...
//global variables
static const byte ht1632_data = 11;      // Data pin for sure module
static const byte ht1632_wrclk = 10;     // Write clock pin for sure module
static const byte ht1632_cs[1] = {
  9
};  // Chip_selects one for each sure module. Remember to set the DIP switches on the modules too.
...
}; //day array - used in slide, normal and jumble modes (The DS1307 outputs 1-7 values for day of week)
char daysfull[7][9] = {
