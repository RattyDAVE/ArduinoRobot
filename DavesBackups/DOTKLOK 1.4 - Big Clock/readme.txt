...
Place the "dotklok_rev_1_4" folder in the Arduino sketches folder (in Windows 7 this is "Libraries/Documents/Arduino", in MAC OS X Lion this is "Documents/Arduino").
